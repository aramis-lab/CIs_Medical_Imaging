...
def make_all_plots(root_folder:str, output_folder:str, upload_overleaf: bool = False, export_format:str="pdf"):
    plot_fig3_basic(root_folder, os.path.join(output_folder, f"fig3_basic.{export_format}"), upload_overleaf=upload_overleaf)
    plot_fig4_bca(root_folder, os.path.join(output_folder, f"fig4_bca.{export_format}"), upload_overleaf=upload_overleaf)
    plot_fig5_param_small_samples(root_folder, os.path.join(output_folder, f"fig5_param_small_samples.{export_format}"), upload_overleaf=upload_overleaf)
    plot_fig6_hoeffding_vs_param_t(root_folder, os.path.join(output_folder, f"fig6_hoeffding_vs_param_t.{export_format}"), upload_overleaf=upload_overleaf)
    plot_fig7_macro_vs_segm_mean(root_folder, os.path.join(output_folder, f"fig7_macro_vs_segm_mean.{export_format}"), upload_overleaf=upload_overleaf)
    plot_fig7bis_micro_vs_segm_mean(root_folder, os.path.join(output_folder, f"fig7bis_micro_vs_segm_mean.{export_format}"), upload_overleaf=upload_overleaf)
    plot_fig8_metrics(root_folder, os.path.join(output_folder, f"fig8_metrics.{export_format}"), upload_overleaf=upload_overleaf)
    plot_fig9_micro_vs_macro(root_folder, os.path.join(output_folder, f"fig9_micro_vs_macro.{export_format}"), upload_overleaf=upload_overleaf)
    plot_fig10_sample_needs(root_folder, os.path.join(output_folder, f"fig10_sample_needs.{export_format}"), upload_overleaf=upload_overleaf)
