...
from .fig6_macro_vs_segm_mean import plot_fig6_macro_vs_segm_mean
from .fig7_metrics import plot_fig7_metrics
from .fig8_micro_vs_macro import plot_fig8_micro_vs_macro
...
def make_all_plots(root_folder:str, output_folder:str):
    ...
    plot_fig6_macro_vs_segm_mean(root_folder, os.path.join(output_folder, "fig6_macro_vs_segm_mean.pdf"))
    plot_fig7_metrics(root_folder, os.path.join(output_folder, "fig7_metrics.pdf"))
    plot_fig8_micro_vs_macro(root_folder, os.path.join(output_folder, "fig8_micro_vs_macro.pdf"))
