...
def plot_fig9_micro_vs_macro(root_folder:str, output_path:str, upload_overleaf: bool = False):
    ...
    ax_cov.set_xlabel('Sample size', weight='bold', fontsize=36)
    ax_cov.set_ylabel('Coverage (%)', weight='bold', fontsize=36)
    ax_cov.tick_params(axis='y', labelsize=32)
    ax_cov.tick_params(axis='x', labelsize=32)
