...
def extract_df_classif_cov(folder_path:str, file_prefix:str, metrics:list[str], averages:list[str])->pd.DataFrame:
    all_values=[]

    for metric in metrics:
        for average in averages:
            file_path = os.path.join(folder_path, f"{file_prefix}_{metric}_{average}.csv")
            data = pd.read_csv(file_path)
...
def extract_df_classif_width(folder_path:str, file_prefix:str, metrics:list[str], averages:list[str])->pd.DataFrame:
    all_values=[]
