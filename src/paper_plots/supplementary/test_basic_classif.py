...
def plot_significance_matrix_segm(significance, p_values, type='micro'):
    ...
    print(pval_matrix, global_matrix)
...
def main(agreg_type):
    ...
    p_values=perform_pairwise_tests(valid_fits)
    print('significance')
    q_values,significance=tell_significance(p_values)

    print('making plot')
    plot_significance_matrix_segm(significance, p_values,agreg_type)
