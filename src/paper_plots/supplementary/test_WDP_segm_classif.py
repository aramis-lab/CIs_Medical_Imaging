...
def plot_significance_matrix_segm_vs_classif(significance,p_values):
...
def main():
    ...
    p_values=perform_pairwise_tests(valid_fits, valid_fits_classif)
    print('significance')
    significance=tell_significance(p_values)
    print('making plot')
    plot_significance_matrix_segm_vs_classif(significance, p_values)
