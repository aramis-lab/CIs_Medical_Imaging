...
def perform_pairwise_tests(df_fit_results, df_fit_results_macro):
...
def main():
    ...
    p_values,i=perform_pairwise_tests(valid_fits,valid_fits_macro)
    print(p_values)
    print('significance')
    q_values,significance=tell_significance(p_values)

    print('making plot')
    plot_significance_matrix_segm(significance, p_values)
